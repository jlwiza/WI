...
void fill_keys_default(Bind_Helper *context){
    ...
    bind(context, key_esc, MDFR_SHIFT, lister__quit);
    ...
    bind(context, key_f8, MDFR_NONE, reopen);
    bind(context, key_f9, MDFR_NONE, toggle_fullscreen);
    ...
    bind(context, key_del, MDFR_NONE, delete_line);
    //bind(context, key_back, MDFR_SHIFT, delete_line);
    ...
    bind(context, key_page_down, MDFR_NONE, seek_beginning_of_line);
    bind(context, key_page_up, MDFR_CTRL, goto_beginning_of_file);
    bind(context, key_page_up, MDFR_NONE, goto_end_of_file);
    ...
    bind(context, key_home, MDFR_NONE, goto_beginning_of_file);
    bind(context, key_page_up, MDFR_NONE, goto_end_of_file);
    ...
    //bind(context, key_back, MDFR_CTRL, delete_line);
    bind(context, key_back, MDFR_SHIFT, delete_range);
    
    bind(context, key_back, MDFR_CTRL, backspace_word);
    //bind(context, key_back, MDFR_CTRL, delete_word);
    ...
    // Make a note to replace and swith this with the t ones
    ...
    // this is important its just shift enter when you want to open the thing in the same panel
